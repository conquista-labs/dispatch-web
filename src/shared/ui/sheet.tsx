    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Largura padrão das laterais SEM o prefixo `data-[side=…]:` (como vinha do shadcn): com o
          // prefixo, o twMerge não reconhece conflito com o `w-[…]`/`sm:max-w-[…]` que cada tela passa,
          // as duas classes ficam e a com prefixo vence — todo painel lateral saía com 384px (75% no
          // celular), ignorando a largura pedida. Achado na auditoria visual de 25/09/2026.
