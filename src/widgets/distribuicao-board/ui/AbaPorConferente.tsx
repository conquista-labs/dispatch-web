      ...
      {conferentes.map((conferente) => {
        ...
        return (
          <ProtocoloColuna
            ...
            tituloLista={`${conferente.nome} · ${grupo?.protocolos.length ?? 0} na mão`}
            subtituloLista="atribuídos e em conferência, ordenados por vencimento. Clique para ver o detalhe."
            variant="conferente"
            resolverInfo={resolverInfo}
            onAbrirDetalhe={onAbrirDetalhe}
            detalheAberto={detalheAberto}
